...
$sql=mysql_query("SELECT nama_makul, id_makul FROM makul where nama_makul LIKE '$huruf%'" );
...
{ ?>
    ...
    <tr>                
        ...
        <td align="center"><?php echo "<a href=admin_menumatakuliah.php?&hpshmakul=$data[id_makul]> hapus</a>"; ?></td>
	</tr> 
    <?php } ?>
</table>
